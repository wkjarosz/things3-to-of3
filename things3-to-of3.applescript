...
-- Made things work with current version of Omnifocus. Including Logbook in list of where to convert projects/tasks
...
tell application "Things3"
	...
	set theTodos to to dos of list "Inbox" & to dos of list "Anytime" & to dos of list "Upcoming" & to dos of list "Someday" & to dos of list "Logbook"
